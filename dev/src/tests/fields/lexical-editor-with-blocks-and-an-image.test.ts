...
describe('Lexical editor with blocks', () => {
  ...
  it('creates an HTML file for Crowdin as expected', async () => {
    ...
    expect(contentHtmlFile?.fileData?.html).toMatchInlineSnapshot(
      `"<div class="payload-richtext"><p>What happens if a block doesn't have any localized fields?</p><span data-block-id=678564c06ec4a6f1fcf6a623 data-block-type=cookieTable></span><p>For example - a block that only contains a select field, which is included twice for good measure!</p><span data-block-id=678564926ec4a6f1fcf6a622 data-block-type=cookieTable></span><p>Also, can we include images and expect those to be included in the final version?</p><p><br /></p><span data-block-id=6807d878f8296947487161eb data-block-type="pcsUpload"></span><p>Some final paragraph text - for good measure (overused phrase at this point).</p></div>"`,
    )
  })
