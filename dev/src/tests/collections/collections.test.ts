import { getFilesByDocumentID, mockCrowdinClient } from 'payload-crowdin-sync'
import {
...
describe('Collections', () => {
  ...
  describe('crowdin-article-directories', () => {
    ...
    it('creates only one article directory', async () => {
      ...
      const crowdinArticleDirectoryId = (
        postRefreshed['crowdinArticleDirectory'] as CrowdinArticleDirectory
      )?.id
    ...
    it('creates unique article directories for two articles created in the same collection', async () => {
      ...
      expect(
        (postOneRefreshed['crowdinArticleDirectory'] as CrowdinArticleDirectory).id,
  ...
  describe('crowdin-collection-directories', () => {
    ...
    it('uses the same collection directory for two articles created in the same collection', async () => {
      ...
      const crowdinArticleDirectoryOne = postOneRefreshed[
        'crowdinArticleDirectory'
      ] as CrowdinArticleDirectory
      const crowdinArticleDirectoryTwo = postTwoRefreshed[
        'crowdinArticleDirectory'
      ] as CrowdinArticleDirectory
      expect(crowdinArticleDirectoryOne.crowdinCollectionDirectory).toEqual(
