    ...
    nock('https://api.crowdin.com')
      ...
      .reply(
        ...
        mockClient.buildProjectFileTranslation({
          url: `https://api.crowdin.com/api/v2/projects/${pluginOptions.projectId}/translations/builds/${48311}/download?targetLanguageId=fr`,
        }),
      )
      ...
      .reply(
        200,
        mockClient.buildProjectFileTranslation({
          url: `https://api.crowdin.com/api/v2/projects/${pluginOptions.projectId}/translations/builds/${48312}/download?targetLanguageId=fr`,
        }),
      )
