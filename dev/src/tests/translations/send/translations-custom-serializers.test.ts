  ...
  describe('fn: updateTranslation - custom serializer', () => {
    it('updates a Payload article with a `richText` field translation retrieved from Crowdin restoring table structure', async () => {
      ...
      nock('https://api.crowdin.com')
        ...
        .reply(
          200,
          '<div class="lexical-table-container"><table class="lexical-table" style="border-collapse: collapse;"><tr class="lexical-table-row"><th class="lexical-table-cell lexical-table-cell-header-1">Text für Überschriftenzelle 1</th><th class="lexical-table-cell lexical-table-cell-header-1">Text für Überschriftenzelle 2</th><th class="lexical-table-cell lexical-table-cell-header-1">Text für Überschriftenzelle 3</th><th class="lexical-table-cell lexical-table-cell-header-1">Text für Überschriftenzelle 4</th></tr class="lexical-table-row"><tr><td class="lexical-table-cell lexical-table-cell-header-0">Text für Tabellenzelle, Zeile 1, Spalte 1</td><td class="lexical-table-cell lexical-table-cell-header-0">Text für Tabellenzelle, Zeile 1, Spalte 2</td><td class="lexical-table-cell lexical-table-cell-header-0">Text für Tabellenzelle, Zeile 1, Spalte 3</td><td class="lexical-table-cell lexical-table-cell-header-0"><p>Absatz 1-Text für Tabellenzelle, Zeile 1, Spalte 4</p><p>Absatz 2-Text für Tabellenzelle, Zeile 1, Spalte 4</p></td></tr></table></div>',
        )
        .post(`/api/v2/projects/${pluginOptions.projectId}/translations/builds/files/${fileId}`, {
          targetLanguageId: 'fr',
        })
