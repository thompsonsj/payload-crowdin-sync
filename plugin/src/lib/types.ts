...
type CollectionOrGlobalConfig =
  | CollectionOrGlobalConfigSlug
  | CollectionOrGlobalConfigObject;

// type guard: determine type of config
export const isCollectionOrGlobalConfigObject = (
  collectionOrGlobalConfig: CollectionOrGlobalConfig,
): collectionOrGlobalConfig is CollectionOrGlobalConfigObject =>
  typeof collectionOrGlobalConfig === 'object';
export const isCollectionOrGlobalConfigSlug = (
  collectionOrGlobalConfig: CollectionOrGlobalConfig,
): collectionOrGlobalConfig is CollectionOrGlobalConfigSlug =>
  typeof collectionOrGlobalConfig === 'string';
