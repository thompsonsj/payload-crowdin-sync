import {
  ...
  SanitizedServerEditorConfig as SanitizedEditorConfig,
...
const isSerializedUploadNode = (
  node: SerializedLexicalNode,
): node is SerializedUploadNode => {
  return node.type === 'upload';
};

export const isLexical = (field: RichTextField): field is RichTextField =>
  (field &&
    field.editor &&
    'editorConfig' in field.editor &&
    'lexical' in (field.editor as LexicalRichTextAdapter).editorConfig) ||
  false;
...
export const getLexicalBlockFields = (
